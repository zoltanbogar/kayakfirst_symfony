...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.avg.training.service' => 'getApp_Avg_Training_ServiceService',
            'app.doctrine.api.exception_listener' => 'getApp_Doctrine_Api_ExceptionListenerService',
            'app.doctrine.hash_password_listener' => 'getApp_Doctrine_HashPasswordListenerService',
            'app.event.service' => 'getApp_Event_ServiceService',
            'app.form.profile' => 'getApp_Form_ProfileService',
            'app.form.registration' => 'getApp_Form_RegistrationService',
            'app.oauthfailurehandler' => 'getApp_OauthfailurehandlerService',
            'app.plan.service' => 'getApp_Plan_ServiceService',
            'app.plan_training.service' => 'getApp_PlanTraining_ServiceService',
            'app.prefilter.json_request_transformer' => 'getApp_Prefilter_JsonRequestTransformerService',
            'app.provider.oauth' => 'getApp_Provider_OauthService',
            'app.security.authentication.handler.authentication_success' => 'getApp_Security_Authentication_Handler_AuthenticationSuccessService',
            'app.security.jwt_token_authenticator' => 'getApp_Security_JwtTokenAuthenticatorService',
            'app.security.login_form_authenticator' => 'getApp_Security_LoginFormAuthenticatorService',
            'app.training.service' => 'getApp_Training_ServiceService',
            'app.user.service' => 'getApp_User_ServiceService',
            ...
            'rms_push_notifications.ios.feedback' => 'getRmsPushNotifications_Ios_FeedbackService',
            ...
            'security.firewall.map.context.ecwid_login' => 'getSecurity_Firewall_Map_Context_EcwidLoginService',
            'security.firewall.map.context.firebase' => 'getSecurity_Firewall_Map_Context_FirebaseService',
            'security.firewall.map.context.main' => 'getSecurity_Firewall_Map_Context_MainService',
            'security.firewall.map.context.refresh' => 'getSecurity_Firewall_Map_Context_RefreshService',
            'security.firewall.map.context.v2' => 'getSecurity_Firewall_Map_Context_V2Service',
            ...
            'security.user_checker.refresh' => 'getSecurity_UserChecker_RefreshService',
        ...
        $this->aliases = array(
            ...
            'hwi_oauth.user_checker' => 'security.user_checker.refresh',
            ...
            'security.user_checker.api' => 'security.user_checker.refresh',
            'security.user_checker.main' => 'security.user_checker.refresh',
    ...
    /**
     * Gets the 'app.avg.training.service' service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Services\AvgTrainingService A AppBundle\Services\AvgTrainingService instance
     */
    protected function getApp_Avg_Training_ServiceService()
    {
        return $this->services['app.avg.training.service'] = new \AppBundle\Services\AvgTrainingService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.doctrine.api.exception_listener' service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Listeners\ApiExceptionListener A AppBundle\Listeners\ApiExceptionListener instance
     */
    protected function getApp_Doctrine_Api_ExceptionListenerService()
    {
        return $this->services['app.doctrine.api.exception_listener'] = new \AppBundle\Listeners\ApiExceptionListener($this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Listeners\HashPasswordListener A AppBundle\Listeners\HashPasswordListener instance
     */
    protected function getApp_Doctrine_HashPasswordListenerService()
    {
        return $this->services['app.doctrine.hash_password_listener'] = new \AppBundle\Listeners\HashPasswordListener($this->get('security.password_encoder'));
    }

    /**
     * Gets the 'app.event.service' service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Services\EventService A AppBundle\Services\EventService instance
     */
    protected function getApp_Event_ServiceService()
    {
        return $this->services['app.event.service'] = new \AppBundle\Services\EventService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'app.oauthfailurehandler' service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Handlers\OAuthFailureHandler A AppBundle\Handlers\OAuthFailureHandler instance
     */
    protected function getApp_OauthfailurehandlerService()
    {
        return $this->services['app.oauthfailurehandler'] = new \AppBundle\Handlers\OAuthFailureHandler($this->get('router'));
    }

    /**
     * Gets the 'app.plan.service' service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Services\PlanService A AppBundle\Services\PlanService instance
     */
    protected function getApp_Plan_ServiceService()
    {
        return $this->services['app.plan.service'] = new \AppBundle\Services\PlanService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.plan_training.service' service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Services\PlanTrainingService A AppBundle\Services\PlanTrainingService instance
     */
    protected function getApp_PlanTraining_ServiceService()
    {
        return $this->services['app.plan_training.service'] = new \AppBundle\Services\PlanTrainingService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.prefilter.json_request_transformer' service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Listeners\JsonRequestTransformerListener A AppBundle\Listeners\JsonRequestTransformerListener instance
     */
    protected function getApp_Prefilter_JsonRequestTransformerService()
    {
        return $this->services['app.prefilter.json_request_transformer'] = new \AppBundle\Listeners\JsonRequestTransformerListener();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\Provider\OAuthUserProvider A AppBundle\Security\Provider\OAuthUserProvider instance
     */
    protected function getApp_Provider_OauthService()
    {
        return $this->services['app.provider.oauth'] = new \AppBundle\Security\Provider\OAuthUserProvider($this->get('session'), $this->get('fos_user.user_manager'), array('facebook' => 'facebookId', 'google' => 'googleId'));
    }

    /**
     * Gets the 'app.security.authentication.handler.authentication_success' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\AuthenticationSuccessHandler A AppBundle\Security\AuthenticationSuccessHandler instance
     */
    protected function getApp_Security_Authentication_Handler_AuthenticationSuccessService()
    {
        return $this->services['app.security.authentication.handler.authentication_success'] = new \AppBundle\Security\AuthenticationSuccessHandler($this->get('lexik_jwt_authentication.jwt_manager'), $this->get('debug.event_dispatcher'), $this->get('app.user.service'));
    }

    /**
     * Gets the 'app.security.jwt_token_authenticator' service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Security\JWTAuthenticator A AppBundle\Security\JWTAuthenticator instance
     */
    protected function getApp_Security_JwtTokenAuthenticatorService()
    {
        return $this->services['app.security.jwt_token_authenticator'] = new \AppBundle\Security\JWTAuthenticator($this->get('doctrine.orm.default_entity_manager'), $this->get('lexik_jwt_authentication.encoder.default'));
    }
    ...
    /**
     * Gets the 'app.training.service' service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Services\TrainingService A AppBundle\Services\TrainingService instance
     */
    protected function getApp_Training_ServiceService()
    {
        return $this->services['app.training.service'] = new \AppBundle\Services\TrainingService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.user.service' service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Services\UserService A AppBundle\Services\UserService instance
     */
    protected function getApp_User_ServiceService()
    {
        return $this->services['app.user.service'] = new \AppBundle\Services\UserService();
    }
    ...
    protected function getAssets_PackagesService()
    {
        ...
        return $this->services['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', $b, $a), array('views_css' => new \Symfony\Component\Asset\PathPackage('css/views/', $b, $a)));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('c2AM-E7LUz', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EjqyoSJFOu', 0, 'd1H8y6k3OYeGRCiQHhCskj', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uAO6dn0h4s', 0, 'd1H8y6k3OYeGRCiQHhCskj', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xVQqJXvh-H', 0, 'd1H8y6k3OYeGRCiQHhCskj', (__DIR__.'/pools'), $a));
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.request', array(0 => 'app.prefilter.json_request_transformer', 1 => 'onKernelRequest'), 0);
        $instance->addListenerService('kernel.exception', array(0 => 'app.doctrine.api.exception_listener', 1 => 'onKernelException'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => 'kayakfirst-pgdb.postgres.database.azure.com', 'port' => 5432, 'dbname' => 'kayakfirst_dev', 'user' => 'kayakroot@kayakfirst-pgdb', 'password' => 'k@y4kf1rst', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/vendor/gesdinet/jwt-refresh-token-bundle/Entity'), 1 => ($this->targetDirs[3].'/src/AppBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Gesdinet\\JWTRefreshTokenBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('GesdinetJWTRefreshTokenBundle' => 'Gesdinet\\JWTRefreshTokenBundle\\Entity', 'AppBundle' => 'AppBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_32ff553f0d469d5e530408dd2e116c68baade581d5d8da0f973c0a8f65d70b70');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('symfony@kayakfirst.com' => 'symfony@kayakfirst.com'), 'resetting' => array('symfony@kayakfirst.com' => 'symfony@kayakfirst.com'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'AppBundle\\Form\\ProfileFormType', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.security.login_manager'] = new \FOS\UserBundle\Security\LoginManager($this->get('security.token_storage'), $this->get('security.user_checker.refresh'), $this->get('security.authentication.session_strategy'), $this->get('request_stack'), NULL);
    }
    ...
    {
        $this->services['gesdinet.jwtrefreshtoken.user_provider'] = $instance = new \Gesdinet\JWTRefreshTokenBundle\Security\Provider\RefreshTokenProvider($this->get('gesdinet.jwtrefreshtoken.refresh_token_manager'));

        $instance->setCustomUserProvider($this->get('fos_user.user_provider.username', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    ...
    {
        return $this->services['hwi_oauth.resource_owner.facebook'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\FacebookResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => 'xxx', 'client_secret' => 'yyy', 'scope' => 'email, public_profile', 'paths' => array('email' => 'email'), 'options' => array('display' => 'page')), 'facebook', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.google'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\GoogleResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => 'xxx', 'client_secret' => 'yyy', 'scope' => 'email profile', 'options' => array('access_type' => 'offline'), 'paths' => array()), 'google', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer/fos'), 'Lexik\\Bundle\\JWTAuthenticationBundle' => ($this->targetDirs[3].'/vendor/lexik/jwt-authentication-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'HWI\\Bundle\\OAuthBundle' => ($this->targetDirs[3].'/vendor/hwi/oauth-bundle/Resources/config/serializer'), 'Gesdinet\\JWTRefreshTokenBundle' => ($this->targetDirs[3].'/vendor/gesdinet/jwt-refresh-token-bundle/Resources/config/serializer'), 'RMS\\PushNotificationsBundle' => ($this->targetDirs[3].'/vendor/richsage/rms-push-notifications-bundle/RMS/PushNotificationsBundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Resources/config/serializer')));
    ...
    {
        return $this->services['lexik_jwt_authentication.key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\KeyLoader\OpenSSLKeyLoader(($this->targetDirs[3].'/app/var/jwt/private.pem'), ($this->targetDirs[3].'/app/var/jwt/public.pem'), 'test');
    }
    ...
    protected function getRmsPushNotificationsService()
    {
        ...
        $instance->addHandler('rms_push_notifications.os.android.c2dm', new \RMS\PushNotificationsBundle\Service\OS\AndroidNotification('', '', '', 5));
        $instance->addHandler('rms_push_notifications.os.android.gcm', new \RMS\PushNotificationsBundle\Service\OS\AndroidGCMNotification('asd', true, 5, $a, NULL, true));
        $instance->addHandler('rms_push_notifications.os.ios', new \RMS\PushNotificationsBundle\Service\OS\AppleNotification(true, ($this->targetDirs[3].'/app/../var/ios_push/api.pem'), 'asdf', false, 60, __DIR__, $this->get('rms_push_notifications.event_listener'), $a));
    ...
    /**
     * Gets the 'rms_push_notifications.ios.feedback' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \RMS\PushNotificationsBundle\Service\iOSFeedback A RMS\PushNotificationsBundle\Service\iOSFeedback instance
     */
    protected function getRmsPushNotifications_Ios_FeedbackService()
    {
        return $this->services['rms_push_notifications.ios.feedback'] = new \RMS\PushNotificationsBundle\Service\iOSFeedback(true, ($this->targetDirs[3].'/app/../var/ios_push/api.pem'), 'asdf', 60);
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|img|js|media)/'), 'security.firewall.map.context.firebase' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(firebase)/'), 'security.firewall.map.context.v2' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(v2)/'), 'security.firewall.map.context.ecwid_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(ecwid_login|ecwid_login_static)'), 'security.firewall.map.context.refresh' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/token/refresh'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        $d = $this->get('app.security.jwt_token_authenticator');
        $e = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);

        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/api/rest'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/api/logout')), 2 => new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($this->get('security.authentication.guard_handler'), $c, 'api', array(0 => $d), $e), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5b7eb925f0dfa3.93010094', $e, $c), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'api', $d, NULL, NULL, $e, true));
    }
    ...
    /**
     * Gets the 'security.firewall.map.context.ecwid_login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance
     */
    protected function getSecurity_Firewall_Map_Context_EcwidLoginService()
    {
        return $this->services['security.firewall.map.context.ecwid_login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }

    /**
     * Gets the 'security.firewall.map.context.firebase' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance
     */
    protected function getSecurity_Firewall_Map_Context_FirebaseService()
    {
        return $this->services['security.firewall.map.context.firebase'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j->setOptions(array('login_path' => '/login', 'default_target_path' => '/', 'always_use_default_target_path' => true, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $m = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($a, $g, $h, $e, 'main', $l, new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationFailureHandler($this->get('app.oauthfailurehandler'), array('login_path' => '/login', 'failure_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path')), array('use_forward' => true, 'check_path' => '/login_check', 'require_previous_session' => true), $b, $c);
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username'), 1 => new \HWI\Bundle\OAuthBundle\Security\Core\User\OAuthUserProvider()), 'main', $b, $c, $d), 2 => $i, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, $h, $e, 'main', $j, $k, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $m, 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5b7eb925f0dfa3.93010094', $b, $g), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $d, $e, 'main', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($f, $e, '/login', true), NULL, NULL, $b, false));
    }

    /**
     * Gets the 'security.firewall.map.context.refresh' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    protected function getSecurity_Firewall_Map_Context_RefreshService()
    {
        ...
        return $this->services['security.firewall.map.context.refresh'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5b7eb925f0dfa3.93010094', $b, $this->get('security.authentication.manager')), 2 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'refresh', NULL, NULL, NULL, $b, true));
    }

    /**
     * Gets the 'security.firewall.map.context.v2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance
     */
    protected function getSecurity_Firewall_Map_Context_V2Service()
    {
        return $this->services['security.firewall.map.context.v2'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    /**
     * Gets the 'security.user_checker.refresh' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_UserChecker_RefreshService()
    {
        return $this->services['security.user_checker.refresh'] = new \Symfony\Component\Security\Core\User\UserChecker();
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('symfony@kayakfirst.com');
        $a->setPassword('kl239sdW');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('87.229.53.38');
        $instance->setPort(25);
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('oLKd9dlsknjer');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/version'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/api_ecwid_login'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/api_contact_us'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/uploadLog'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/rest'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/users/pwreset'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/users/getMessage'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/users/broadcastPush'), array(0 => 'ROLE_ADMIN'), NULL);
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/firebase'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/shop'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/v2'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/ecwid_login'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/ecwid_login_static'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $b = $this->get('security.user_checker.refresh');

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5b7eb925f0dfa3.93010094'), 1 => new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(array(0 => $this->get('app.security.jwt_token_authenticator')), $a, 'api', $b), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5b7eb925f0dfa3.93010094'), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $this->get('security.encoder_factory'), true), 4 => new \HWI\Bundle\OAuthBundle\Security\Core\Authentication\Provider\OAuthProvider($this->get('app.provider.oauth'), $this->get('hwi_oauth.resource_ownermap.main'), $b), 5 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5b7eb925f0dfa3.93010094')), true);
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('api', '/api/logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'kayakfirst-pgdb.postgres.database.azure.com',
            'database_port' => 5432,
            'database_name' => 'kayakfirst_dev',
            'database_user' => 'kayakroot@kayakfirst-pgdb',
            'database_password' => 'k@y4kf1rst',
            'mailer_transport' => 'smtp',
            'mailer_host' => '87.229.53.38',
            'mailer_user' => 'symfony@kayakfirst.com',
            'mailer_password' => 'kl239sdW',
            'secret' => 'oLKd9dlsknjer',
            ...
            'facebook.client_secret' => 'yyy',
            'google.client_id' => 'xxx',
            'google.client_secret' => 'yyy',
            'android_gcm_api_key' => 'asd',
            'android_gcm_dry_run' => true,
            'ios_push_path_to_pem' => ($this->targetDirs[3].'/app/../var/ios_push/api.pem'),
            'ios_push_passphrase' => 'asdf',
            'ios_push_dry_run' => true,
            'locale' => 'en',
            ...
            'session.save_path' => ($this->targetDirs[3].'/app/../tmp/'),
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => '87.229.53.38',
            'swiftmailer.mailer.default.transport.smtp.username' => 'symfony@kayakfirst.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'kl239sdW',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'symfony@kayakfirst.com' => 'symfony@kayakfirst.com',
            ),
            ...
            'gesdinet_jwt_refresh_token.user_provider' => 'fos_user.user_provider.username',
            ...
            'rms_push_notifications.android.gcm.api_key' => 'asd',
            'rms_push_notifications.android.gcm.use_multi_curl' => true,
            'rms_push_notifications.android.gcm.dry_run' => true,
            ...
            'rms_push_notifications.ios.timeout' => 60,
            'rms_push_notifications.ios.sandbox' => true,
            'rms_push_notifications.ios.pem' => ($this->targetDirs[3].'/app/../var/ios_push/api.pem'),
            'rms_push_notifications.ios.passphrase' => 'asdf',
            'rms_push_notifications.ios.json_unescaped_unicode' => false,
